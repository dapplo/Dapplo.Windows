...
namespace Dapplo.Windows.Native
{
	...
	public static class Gdi32
	{
		...
		/// <param name="rasterOperation">A raster-operation code. These codes define how the color data for the source rectangle is to be combined with the color data for the destination rectangle to achieve the final color.</param>
		/// <returns></returns>
		...
		/// See <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/dd183489(v=vs.85).aspx">CreateCompatibleDC function</a>
		/// </summary>
		...
		/// See <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/dd183494(v=vs.85).aspx">CreateDIBSection function</a>
		/// </summary>
		...
		/// <param name="bmi">A pointer to a BITMAPINFO structure that specifies various attributes of the DIB, including the bitmap dimensions and colors.</param>
		/// <param name="usage">
		...
		/// <param name="hSection">A handle to a file-mapping object that the function will use to create the DIB. This parameter can be NULL.
		...
		/// See <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/dd183514(v=vs.85).aspx">CreateRectRgn function</a>
		/// </summary>
		...
		/// <summary>
		/// See <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/dd144877(v=vs.85).aspx">GetDeviceCaps function</a>
		...
		/// <returns>The return value is the COLORREF value that specifies the RGB of the pixel. If the pixel is outside of the current clipping region, the return value is CLR_INVALID (0xFFFFFFFF defined in Wingdi.h).</returns>
		[DllImport("gdi32", SetLastError = true)]
		...
		/// </summary>
		/// <param name="hDc">A handle to the DC.</param>
		/// <param name="hObject">A handle to the object to be selected. The specified object must have been created by using one of the following functions.
		/// Object	Functions
		...
		/// <summary>
		/// See <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/dd145120(v=vs.85).aspx">StretchBlt function</a>
		/// </summary>
		/// <param name="hdcDest">A handle to the destination device context.</param>
		...
		/// <param name="rasterOperation">he raster operation to be performed. Raster operation codes define how the system combines colors in output operations that involve a brush, a source bitmap, and a destination bitmap.
