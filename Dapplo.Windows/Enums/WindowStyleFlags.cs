...
namespace Dapplo.Windows.Enums
{
	...
	public enum WindowStyleFlags : uint
	{
		...
		/// that is, when a particular child window receives a WM_PAINT message, the WS_CLIPSIBLINGS style clips all other overlapping child windows out of the region of the child window to be updated.
