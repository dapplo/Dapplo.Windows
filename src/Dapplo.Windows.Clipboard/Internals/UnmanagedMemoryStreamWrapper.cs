...
{
    /// <summary>
    /// This wraps an UnmanagedMemoryStream, to also take care or unlocking the global locked memory
    /// </summary>
    internal class UnmanagedMemoryStreamWrapper : UnmanagedMemoryStream
    {
        private IntPtr _hGlobal = IntPtr.Zero;
        ...
        public void SetGlobal(IntPtr hGlobal)
        {
            _hGlobal = hGlobal;
        }
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            {
                Kernel32Api.GlobalUnlock(_hGlobal);
            }
        }
    }
}
