...
public static class User32Api
{
    ...
    public static IntPtr SetWindowLongWrapper(IntPtr hWnd, WindowLongIndex index, IntPtr styleFlags)
    {
        if (IntPtr.Size == 8)
        {
            return SetWindowLongPtr(hWnd, index, styleFlags);
        }

        return new IntPtr(SetWindowLong(hWnd, index, styleFlags.ToInt32()));
    }
