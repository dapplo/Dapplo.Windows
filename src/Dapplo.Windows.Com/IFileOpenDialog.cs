...
/// </summary>
/// <remarks>
/// The CLSID for the FileOpenDialog coclass is <c>{DC1C5A9C-E88A-4DDE-A5A1-60F82A20AEF7}</c>.
/// </remarks>
[ComImport]
...
public interface IFileOpenDialog
{
    ...
    /// <summary>
    /// Gets the currently selected items in the dialog. These items may be items selected in the view, or text typed in the filename edit box.
    /// </summary>
