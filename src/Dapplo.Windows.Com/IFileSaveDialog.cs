...
/// <summary>
/// Extends the IFileDialog interface by adding methods specific to the save dialog.
...
/// </summary>
/// <remarks>
/// The CLSID for the FileSaveDialog coclass is <c>{C0B4E2F3-BA21-4773-8DBA-335EC946EB8B}</c>.
/// </remarks>
[ComImport]
...
public interface IFileSaveDialog
{
    ...
    /// </summary>
    /// <param name="pStore">Pointer to the interface that represents the property store containing the associated metadata.</param>
    void SetProperties([In] nint pStore);

    /// <summary>
    /// Specifies which properties will be collected in the save dialog.
    /// </summary>
    /// <param name="pList">Pointer to the interface that represents the list of properties to collect.</param>
    /// <param name="fAppendDefault">TRUE to show default properties for the currently selected file type in addition to the properties specified by pList. FALSE to show only the properties specified by pList.</param>
    ...
    /// </summary>
    /// <param name="ppStore">Address of a pointer to an IPropertyStore, which receives the property values.</param>
    void GetProperties(out nint ppStore);

    /// <summary>
    /// Applies a set of properties to an item using the Shell's copy engine.
    /// </summary>
    /// <param name="psi">Pointer to the IShellItem that represents the file being saved.</param>
    /// <param name="pStore">Pointer to the IPropertyStore that represents the property values to be applied to the file.</param>
    /// <param name="hwnd">The handle of the application window.</param>
    /// <param name="pSink">Pointer to an optional IFileOperationProgressSink that the calling application can use if they want to be notified of the progress of the property stamping.</param>
