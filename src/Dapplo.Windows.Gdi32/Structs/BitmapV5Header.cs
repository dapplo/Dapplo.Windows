...
namespace Dapplo.Windows.Gdi32.Structs
{
    ...
    public struct BitmapV5Header
    {
        ...
        /// <summary>
        ///     Specifies the compression used to store the bitmap
        /// </summary>
        public BitmapCompressionMethods CompressionMethod
        {
            get => (BitmapCompressionMethods)_biCompression;
            set => _biCompression = (uint)value;
        }
        ...
        /// <param name="compression">uint with the compression used</param>
        public static BitmapV5Header Create(int width, int height, ushort bpp, uint? compression = null)
        {
            return new BitmapV5Header
            {
                ...
                // Should always be 1
                _biPlanes = 1,
                _biCompression = compression ?? (uint)BitmapCompressionMethods.BI_RGB,
                _biWidth = width,
                _biHeight = height,
                _biBitCount = bpp,
        ...
        public uint OffsetToPixels
        {
            get
            {
                if (_biCompression == (uint)BitmapCompressionMethods.BI_BITFIELDS)
                {
